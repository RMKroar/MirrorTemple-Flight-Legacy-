...
public class LuianEncounter : Boss {
    ...
    void Start()
    {
        ...
        GameObject.Find("DialogPanel").GetComponent<DialogController>().InvokeDialog(4);
    }

    IEnumerator FadeoutBGM()
    {
        AudioSource audio = GameObject.Find("Stage_Luian(Clone)").GetComponent<AudioSource>();
